...
dataframe2=pd.DataFrame({"E":[17,18,19,20],"F":[21,22,23,24],"G":[25,26,27,28],"H":[29,30,31,32]},index=["k0","k1","k22","k33"])
...
d1d2c=pd.concat([dataframe1,dataframe2],axis=1)
print(d1d2c)
